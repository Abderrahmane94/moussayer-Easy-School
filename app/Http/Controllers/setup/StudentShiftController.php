...
class StudentShiftController extends Controller
{
    public function ViewShift()
    {
        ...
        return view('doreViews.setup.shift.view_shift', $data);

    }

    public function StudentShiftAdd()
    {
        return view('doreViews.setup.shift.add_shift');
    }
    ...
    public function StudentShiftEdit($id)
    {
        ...
        return view('doreViews.setup.shift.edit_shift', compact('editData'));
