...
class AssignSubjectController extends Controller
{
    public function ViewAssignSubject()
    {
        ...
        return view('doreViews.setup.assign_subject.view_assign_subject', $data);
    }
    ...
    public function AddAssignSubject()
    {
        ...
        return view('doreViews.setup.assign_subject.add_assign_subject', $data);
    }
    ...
    public function EditAssignSubject($class_id)
    {
        ...
        $data['subjects'] = SchoolSubject::all();
        $data['classes'] = StudentClass::all();
        return view('doreViews.setup.assign_subject.edit_assign_subject', $data);
    ...
    public function DetailsAssignSubject($class_id)
    {
        ...
        return view('doreViews.setup.assign_subject.details_assign_subject', $data);
