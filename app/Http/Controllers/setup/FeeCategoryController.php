...
class FeeCategoryController extends Controller
{
    public function ViewFeeCat()
    {
        ...
        return view('doreViews.setup.fee_category.view_fee_cat', $data);
    ...
    {
        return view('doreViews.setup.fee_category.add_fee_cat');
    }
    ...
    public function FeeCatEdit($id)
    {
        ...
        return view('doreViews.setup.fee_category.edit_fee_cat', compact('editData'));
