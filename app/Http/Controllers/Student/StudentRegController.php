...
class StudentRegController extends Controller
{
    public function StudentRegView(){
        ...
        return view('doreViews.student.student_reg.student_view',$data);
    ...
    public function StudentRegAdd(){
        ...
        return view('doreViews.student.student_reg.student_add',$data);
    }
...
//            $user->religion = $request->religion;
            ...
            if ($request->file('image')) {
                ...
                $user['profile_photo_path'] = '/img/profiles/'.$filename;
            }
            $user->save();
    ...
    public function StudentRegEdit($student_id){
        ...
        return view('doreViews.student.student_reg.student_edit',$data);
    ...
    public function StudentRegUpdate(Request $request,$student_id){
        ...
        DB::transaction(function() use($request,$student_id){
            ...
            if ($request->file('image')) {
                $file = $request->file('image');
                @unlink(public_path('/img/profiles' . $user->profile_photo_path));
                $filename = date('YmdHi') . $file->getClientOriginalName();
                $file->move(public_path('/img/profiles'), $filename);
                $user['profile_photo_path'] = '/img/profiles/'.$filename;
            }
...
//            dd($request->id);
    ...
    public function StudentRegPromotion($student_id){
        ...
        return view('doreViews.student.student_reg.student_promotion',$data);
    ...
    public function StudentRegDetails($student_id){
        ...
        $pdf = PDF::loadView('doreViews.student.student_reg.student_details_pdf', $data);
