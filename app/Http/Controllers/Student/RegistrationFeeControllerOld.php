...
class RegistrationFeeControllerOld extends Controller
{
    public function RegFeeView(){
        $data['years'] = StudentYear::all();
        $data['classes'] = StudentClass::all();
        return view('doreViews.student.registration_fee.registration_fee_view',$data);
    }
    ...
    public function RegFeePayslip(Request $request){
        ...
        $pdf = PDF::loadView('doreViews.student.registration_fee.registration_fee_pdf', $allStudent);
