...
@section('admin')
    ...
    <div class="col-12">
        <h5 class="mb-4">{{__('Student Promotion')}}</h5>

        <div class="card mb-4">
            <div class="card-body">
                <form class="needs-validation tooltip-label-right" novalidate="novalidate" method="post"
                      action="{{ route('promotion.student.registration',$editData->student_id) }}" enctype="multipart/form-data">
                    ...
                    <input type="submit" class="btn btn-primary mb-0" value="{{__('Promotion')}}">
