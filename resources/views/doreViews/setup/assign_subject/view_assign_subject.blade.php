...
@section('admin')
    <div class="container-fluid disable-text-selection">
        <div class="row">
            <div class="col-12">
                <div class="mb-3">
                    <h1> {{ __('Assign Subject List') }}</h1>
                    <div class="text-zero top-right-button-container">
                        <a type="button" href="{{ route('assign.subject.add') }}"
                           class="btn btn-primary btn-lg top-right-button mr-1">{{__('New Assign Subject')}}</a>
                    </div>
                        ...
                        <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                            <div
                                ...
                                <a class="w-40 w-sm-100">
                                    <p class="list-item-heading mb-0 truncate">{{$assign['student_class']['name']}}</p>
                                </a>
                                <p class="mb-0 text-muted text-small w-15 w-sm-100">{{$key+1}}</p>
