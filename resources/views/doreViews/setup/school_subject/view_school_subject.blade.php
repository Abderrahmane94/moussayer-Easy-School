...
@section('admin')
    <div class="container-fluid disable-text-selection">
        <div class="row">
            <div class="col-12">
                <div class="mb-3">
                    <h1> {{ __('School Subject List') }}</h1>
                    <div class="text-zero top-right-button-container">
                        <a type="button" href="{{ route('setup.subject.add') }}"
                           class="btn btn-primary btn-lg top-right-button mr-1">{{__('New School Subject')}}</a>
                    </div>
        ...
        <div class="row">
            <div class="col-12 list" data-check-all="checkAll">
                ...
                @forelse ($allData as $key => $subject)
                        ...
                        <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                            <div
                                ...
                                <a  class="w-40 w-sm-100">
                                    <p class="list-item-heading mb-0 truncate">{{$subject->name}}</p>
                                </a>
                                <p class="mb-0 text-muted text-small w-15 w-sm-100">{{$subject->created_at}}</p>
                                ...
                                <div>
                                    ...
                                    <div class="position-absolute card-top-buttons ">
                                        <a href="{{ route('setup.subject.edit',$subject->id) }}"
                                           class="btn btn-outline-info icon-button">

                                            <i class="fa fa-pencil-square-o"></i></a>
                                        <a href="{{ route('setup.subject.delete',$subject->id) }}"
