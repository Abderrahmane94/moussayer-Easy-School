...
@section('admin')
    <div class="container-fluid disable-text-selection">
        <div class="row">
            <div class="col-12">
                <div class="mb-3">
                    <h1> {{ __('Student Class List') }}</h1>
                    <div class="text-zero top-right-button-container">
                        <a type="button" href="{{ route('student.class.add') }}"
                           class="btn btn-primary btn-lg top-right-button mr-1">{{__('New Student Class')}}</a>
                    </div>
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <div class="position-absolute card-top-buttons ">
                                        <a href="{{ route('student.class.edit',$user->id) }}"
                                           class="btn btn-outline-info icon-button">

                                            <i class="fa fa-pencil-square-o"></i></a>
                                        <a href="{{ route('student.class.delete',$user->id) }}"
