...
@section('admin')
    <div class="container-fluid disable-text-selection">
        <div class="row">
            <div class="col-12">
                <div class="mb-3">
                    <h1> {{ __('Student Group List') }}</h1>
                    <div class="text-zero top-right-button-container">
                        <a type="button" href="{{ route('student.group.add') }}"
                           class="btn btn-primary btn-lg top-right-button mr-1">{{__('New Student Group')}}</a>
                    </div>
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <div class="position-absolute card-top-buttons ">
                                        <a href="{{ route('student.group.edit',$user->id) }}"
                                           class="btn btn-outline-info icon-button">

                                            <i class="fa fa-pencil-square-o"></i></a>
                                        <a href="{{ route('student.group.delete',$user->id) }}"
