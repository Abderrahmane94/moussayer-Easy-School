...
@section('admin')
    <div class="container-fluid disable-text-selection">
        <div class="row">
            <div class="col-12">
                <div class="mb-3">
                    <h1> {{ __('Student Fee amount List') }}</h1>
                    <div class="text-zero top-right-button-container">
                        <a type="button" href="{{ route('fee.amount.add') }}"
                           class="btn btn-primary btn-lg top-right-button mr-1">{{__('New Fee Category')}}</a>
                    </div>
                        ...
                        <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                            <div
                                ...
                                <a class="w-40 w-sm-100">
                                    <p class="list-item-heading mb-0 truncate">{{$amount['fee_cateogry']['name']}}</p>
                                </a>
