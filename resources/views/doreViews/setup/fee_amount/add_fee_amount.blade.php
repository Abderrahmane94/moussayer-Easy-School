                    ...
                    <div class="add_item">
                        <div class="form-group ">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="custom-select" name="fee_category_id">
                                    <option selected="" disabled="">Choose...</option>
                                    @forelse($fee_categories as $categorie )
                                        <option value="{{$categorie->id}}">{{$categorie->name}}</option>
                                    @empty
                                        <option disabled="">Empty Category Fee</option>
                                    @endforelse
                                </select>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-5">
                                    <h5 class="mb-2">Students Class List<span
