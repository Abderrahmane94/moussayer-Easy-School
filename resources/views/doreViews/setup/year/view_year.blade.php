            ...
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <div class="text-zero top-right-button-container">
                        <a type="button" href="{{ route('student.year.add') }}"
                           class="btn btn-primary btn-lg top-right-button mr-1">{{__('New Student Year')}}</a>
                    </div>
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <div class="position-absolute card-top-buttons ">
                                        <a href="{{ route('student.year.edit',$user->id) }}"
                                           class="btn btn-outline-info icon-button">

                                            <i class="fa fa-pencil-square-o"></i></a>
                                        <a href="{{ route('student.year.delete',$user->id) }}"
