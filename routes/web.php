...
// School Subject All Routes
        ...
        Route::get('setup/subject/view', [SchoolSubjectController::class, 'ViewSubject'])->name('setup.subject.view');

        Route::get('setup/subject/add', [SchoolSubjectController::class, 'SubjectAdd'])->name('setup.subject.add');

        Route::post('setup/subject/store', [SchoolSubjectController::class, 'SubjectStore'])->name('store.setup.subject');

        Route::get('setup/subject/edit/{id}', [SchoolSubjectController::class, 'SubjectEdit'])->name('setup.subject.edit');

        Route::post('setup/subject/update/{id}', [SchoolSubjectController::class, 'SubjectUpdate'])->name('update.setup.subject');

        Route::get('setup/subject/delete/{id}', [SchoolSubjectController::class, 'SubjectDelete'])->name('setup.subject.delete');
